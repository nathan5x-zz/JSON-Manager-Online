...
; require("/Users/Nathan5x/Documents/Apps/GitHub/JSON-Manager/node_modules/jquery/dist/jquery.js");
_ = global._ = require("/Users/Nathan5x/Documents/Apps/GitHub/JSON-Manager/node_modules/lodash");
...
},{"/Users/Nathan5x/Documents/Apps/GitHub/JSON-Manager/node_modules/jquery/dist/jquery.js":3,"/Users/Nathan5x/Documents/Apps/GitHub/JSON-Manager/node_modules/lodash":5}],2:[function(require,module,exports){
 ...
 * Router creates the abstract structure, and it in-turn creates Editor and Viewer DOM elements
 *
 * @module app
 */
...
},{"./router":9}],7:[function(require,module,exports){
'use strict';
...
/**
 * Creates a MainViewModel for rendering the main view Editor and Viewer
 *
 * Examples:
 *
...
},{"./models/MainViewModel":8,"./views/module/main":12,"backbone":1,"jquery":3}],10:[function(require,module,exports){
'use strict';
...
/**
 * Creates a base view for JSON Editor
 * Examples:
 *
...
module.exports = Backbone.View.extend({
   ...
   /**
    * Cleans up the view.  Should be extended in every subview to take care of
    * any cleanup tasks that need to happen when that view is not currently visible.
    *
    * @method clean
    * @return {null}
    **/
    clean: function() {
        throw new Error('Unimplemented AbstractView method clean().');
    },
...
},{"../_extend/baseView":10,"./templateManager":13,"format-json":2,"jquery":3,"json-markup":4,"underscore":5}],12:[function(require,module,exports){
'use strict';
...
},{"../../models/JSONViewModel":7,"../_extend/baseView":10,"../source.json":14,"./json-editor":11,"./templateManager":13,"underscore":5}],13:[function(require,module,exports){
'use strict';
...
},{"../templates.json":15,"underscore":5}],14:[function(require,module,exports){
module.exports={
...
module.exports={
  "mainViewTemplate" : "<header>\
      <h2 class='appname'> JSON Manager </h2>\
      <a href='#' class='btn btn-sm btn-info pull-right' id='downloadButton' download='ExportedJSON.json'>\
      ...
      <div class='row'>\
        <div class='col-md-6'>\
          <div class='panel panel-info'>\
            <div class='panel-heading'>JSON Editor</div>\
             <section id='jsonEditorSection' class='json-editor-view'> </section>\
            </ul>\
          </div>\
        </div>\
        <div class='col-md-6'>\
          <div class='panel panel-success'>\
            <div class='panel-heading'>JSON Viewer (Real-time)</div>\
             <section id='jsonViewerSection' class='json-export-view'> <div> </div> </section>\
            </ul>\
          </div>\
        </div>\
      </div>\
